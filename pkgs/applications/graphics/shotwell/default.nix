...
, webkitgtk_2_4, pkgconfig, gnome3, gst_all_1, which, udev, libraw, glib, json_glib
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ m4 glibc gtk3 libexif libgphoto2 libsoup libxml2 vala sqlite webkitgtk_2_4
