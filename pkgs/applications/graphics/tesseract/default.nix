...
let
  tessdata = stdenv.mkDerivation {
    name = "tessdata-2015-08-03";

    src = fetchFromGitHub {
      owner = "tesseract-ocr";
      repo = "tessdata";
      rev = "6c9657715d38cb44aea9135605860b1b61b0e275";
      sha256 = "0f1njg26a6887vzyqyprxqn30biv7g1wqrn98a6wmk74dvaxf59x";
    };
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "1363in7hz866ncrr34w422p0mihjkz1zhkjshayakyz14nv4hvky";
  };

  # Passing tessdata-prefix (enable or disable), disables setting
  # TESSDATA-PREFIX during compile time.
  configureFlags = [
    # ScrollView
    "--enable-graphics"
    "--disable-embedded"
    ...
    (enFlag "training" trainingTools null)
  ];
